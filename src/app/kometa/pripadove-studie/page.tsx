  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-semibold" style={{ color: '#B45309' }}>Případové studie</span>
      </motion.nav>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 pt-16 pb-10">
        ...
        >
          ...
          <p className="text-lg text-white/40 max-w-xl leading-relaxed">
            Tři kluby, které aplikaci využily k řešení konkrétní výzvy s měřitelnými výsledky.
          </p>
        </motion.div>
      </div>
