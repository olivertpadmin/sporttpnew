...
export default function HradecLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const res = await fetch('/api/hradec-auth', {
      method: 'POST',
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2" style={{
        ...
        background: 'radial-gradient(ellipse at center bottom, rgba(232,34,43,0.22) 0%, transparent 70%)',
        filter: 'blur(20px)',
      }} />
      ...
      <div className="relative z-10 flex flex-col items-center gap-7 w-full max-w-sm px-6">
        ...
        <img
          src="/media/hradec-logo.png"
          alt="FC Hradec Králové"
          style={{ width: 140, height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 2px 12px rgba(0,0,0,0.6))' }}
        />
        ...
        <div className="flex flex-col items-center gap-1.5 text-center">
          ...
          >
            Prezentace pro FC Hradec Králové
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
          <input
            ...
            onFocus={e => {
              if (!error) e.currentTarget.style.border = '1px solid rgba(232,34,43,0.8)'
              e.currentTarget.style.boxShadow = '0 0 0 3px rgba(232,34,43,0.2)'
            }}
            onBlur={e => {
          ...
          <button
            ...
            style={{
              background: loading || !password
                ? 'rgba(232,34,43,0.5)'
                : 'linear-gradient(135deg, #E8222B 0%, #8B0000 100%)',
              fontFamily: "'Mulish', sans-serif",
              letterSpacing: '0.06em',
              boxShadow: loading || !password ? 'none' : '0 4px 20px rgba(232,34,43,0.4)',
            }}
          >
