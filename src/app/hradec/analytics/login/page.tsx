...
export default function HradecAnalyticsLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const res = await fetch('/api/hradec-analytics-auth', {
      method: 'POST',
    ...
    >
      <div className="relative z-10 flex flex-col items-center gap-7 w-full max-w-sm px-6">
        ...
        <img
          ...
          style={{ width: 100, height: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 2px 12px rgba(0,0,0,0.6))' }}
        />
        ...
        <div className="flex flex-col items-center gap-1.5 text-center">
          ...
          <p className="text-xs font-semibold tracking-[0.22em] uppercase" style={{ color: 'rgba(255,255,255,0.35)' }}>
            FC Hradec Králové · interní přístup
          </p>
        </div>
