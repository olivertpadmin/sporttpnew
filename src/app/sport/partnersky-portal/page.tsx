  ...
  return (
    <div className="min-h-screen bg-[#F5F0FF]" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      ...
      {/* ══════════════════════════════════════════════════
          SEKCE 1 – Pro koho
      ══════════════════════════════════════════════════ */}
      <section id="pro-koho" className="py-20 bg-[#F5F0FF]">
        <div className="max-w-5xl mx-auto px-8">
          <motion.div {...iv(0.05)} className="mb-10">
            ...
            <h2
              className="text-4xl md:text-5xl font-black text-[#0f0028] mt-3 mb-4 leading-none"
              style={{ fontFamily: "'Panel Sans', sans-serif" }}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            {FOR_WHOM.map((item, i) => (
              <motion.div
                key={item.title}
                {...iv(0.05 + i * 0.07)}
                className="rounded-2xl p-5 flex flex-col gap-3 border border-[#9333EA]/15 hover:border-[#6366F1]/30 transition-colors"
                style={{ background: i === 0 ? `${ACCENT}07` : undefined }}
              >
                <span className="text-3xl">{item.icon}</span>
                <h3 className="font-bold text-[#0f0028] text-sm leading-snug" style={{ fontFamily: "'Panel Sans', sans-serif" }}>
                  {item.title}
                </h3>
      ...
      ══════════════════════════════════════════════════ */}
      <section id="co-umi" className="py-20" style={{ background: '#EDE5FF' }}>
        <div className="max-w-5xl mx-auto px-8">
          <motion.div {...iv(0.05)} className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {PARTNER_FEATURES.map((f, i) => (
              ...
              >
                ...
                <h3
                  className="font-bold text-[#0f0028] text-base leading-snug"
                  style={{ fontFamily: "'Panel Sans', sans-serif" }}
                >
                  {f.title}
                </h3>
      ...
      <section
        id="pro-klub"
        className="py-20"
        style={{ background: 'linear-gradient(150deg, #0a0018 0%, #1a0840 50%, #0f0530 100%)' }}
      >
        <div className="max-w-5xl mx-auto px-8">
          <motion.div {...iv(0.05)} className="mb-10">
      ...
      ══════════════════════════════════════════════════ */}
      <section id="screenshoty" className="py-20 bg-[#F5F0FF]">
        <div className="max-w-5xl mx-auto px-8">
          <motion.div {...iv(0.05)} className="mb-10">
