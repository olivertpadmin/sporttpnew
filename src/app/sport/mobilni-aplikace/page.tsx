        ...
        <div style={{ padding: '18px 12px 12px', display: 'flex', flexDirection: 'column', height: '100%' }}>
          <div style={{ textAlign: 'center', marginBottom: 10 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <div style={{ width: 28, height: 28, borderRadius: 6, background: 'rgba(255,255,255,0.08)', position: 'relative', overflow: 'hidden', fontSize: 16, fontWeight: 900, color: '#EDE5FF', fontFamily: "'Panel Sans', sans-serif" }}>
                ...
                <div style={{ width: 28, height: 28, borderRadius: 6, background: 'rgba(255,255,255,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, fontWeight: 900, color: '#EDE5FF' }}>0</div>
              </div>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2.2 }} style={{ marginTop: 10 }}>
            <motion.div
              ...
              <span style={{ fontSize: 8, fontWeight: 800, color: '#EDE5FF', letterSpacing: '0.01em' }}>Koupit vstupenku na zápas</span>
...
export default function SportMobilniAplikacePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0FF]" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      ...
      {SECTIONS.map((group, gi) => {
        const groupBg = gi % 2 === 0 ? '#ffffff' : '#EDE5FF'
        return (
            ...
            <section id={NAV_IDS[gi]} className="pt-20 pb-4">
              <div className="max-w-5xl mx-auto px-8">
                <motion.div {...iv(0.1)}>
                  ...
                  <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-0 leading-none"
                  ...
                  <div className="max-w-5xl mx-auto px-8">
                    <motion.div {...iv(0.1)}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <h3 className="text-2xl md:text-3xl font-bold text-[#0f0028] mb-3 leading-tight"
                          style={{ fontFamily: "'Panel Sans', sans-serif" }}>
                          {sub.title}
                        </h3>
      ...
      <div className="max-w-5xl mx-auto px-8 pb-24">
        ...
        <motion.section id="pricing" {...iv(0.1)} className="pt-20 mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-2 leading-none" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Dvě úrovně, jedna platforma</h2>
            ...
            {TIERS.map((tier) => (
              <div key={tier.name} className="rounded-2xl p-7"
                ...
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-xl font-black text-[#0f0028]" style={{ fontFamily: "'Panel Sans', sans-serif" }}>{tier.name}</span>
                ...
                <ul className="space-y-2.5">
                  {tier.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5 text-sm text-[#0f0028]/80">
        ...
        <motion.section id="verticals" {...iv(0.1)} className="mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-2 leading-none" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Dostupné pro každý segment</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {MUTATIONS.map((m) => (
              <div key={m.name} className="p-5 rounded-2xl border border-[#9333EA]/15 hover:border-[#7C3AED]/30 transition-colors">
                <span className="text-3xl mb-3 block">{m.icon}</span>
                <h3 className="font-bold text-[#0f0028] text-base mb-1.5">{m.name}</h3>
        ...
        <motion.section id="roadmap" {...iv(0.1)} className="mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-2 leading-none" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Co přichází</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {COMING_SOON.map((c) => (
              <div key={c.title} className="p-6 rounded-2xl"
                ...
                <h3 className="font-bold text-[#0f0028] text-base mb-2">{c.title}</h3>
        ...
        <motion.section id="clients" {...iv(0.1)}>
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-8 leading-none" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Příklady klientů</h2>
                ...
                <div className="flex flex-wrap gap-2.5">
                  {group.clubs.map((e) => (
                    <div key={e.name} className="flex items-center gap-2.5 px-4 py-2.5 rounded-full border transition-colors"
                      ...
                      <span className="text-sm font-medium text-[#0f0028]">{e.name}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <motion.div
            {...iv(0.15)}
            className="mt-14 rounded-3xl border border-[#9333EA]/15 bg-[#EDE5FF] px-4 py-8 md:px-8 md:py-10 overflow-hidden"
          >
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-7">
              <div>
                <h3
                  className="text-xl md:text-2xl font-bold text-[#0f0028] mb-1"
                  style={{ fontFamily: "'Panel Sans', sans-serif" }}
                >
