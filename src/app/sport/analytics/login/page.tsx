...
export default function SportAnalyticsLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const res = await fetch('/api/sport-analytics-auth', {
      method: 'POST',
      ...
      <div className="relative z-10 flex flex-col items-center gap-7 w-full max-w-sm px-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
          <input
            ...
            onFocus={e => {
              if (!error) e.currentTarget.style.border = '1px solid rgba(147,51,234,0.85)'
              e.currentTarget.style.boxShadow = '0 0 0 3px rgba(147,51,234,0.22)'
            }}
            onBlur={e => {
          ...
          <button
            ...
            style={{
              ...
              boxShadow: loading || !password ? 'none' : '0 4px 20px rgba(147,51,234,0.4)',
            }}
          >
