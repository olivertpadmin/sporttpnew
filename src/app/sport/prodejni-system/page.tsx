...
export default function ISPage() {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(150deg, #0f0028 0%, #1e0a4a 50%, #12063a 100%)' }}
    >
      {/* Textura */}
      ...
      <motion.nav
        ...
        style={{ background: 'rgba(15,0,40,0.92)', backdropFilter: 'blur(18px)', borderBottom: '1px solid rgba(255,255,255,0.08)' }}
