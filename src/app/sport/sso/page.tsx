...
export default function SportSSOPage() {
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  {f.image ? (
                    ...
                    <div className="w-full rounded-2xl border border-[#9333EA]/15 flex items-center justify-center" style={{ aspectRatio: '4/3', background: 'linear-gradient(135deg, #f5f5f5 0%, #ebebeb 100%)' }}>
