...
export default function SportCashlessPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0FF]" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      ...
      {/* THE OPPORTUNITY */}
      <motion.section id="opportunity" {...fade(0.1)} className="py-24 bg-[#F5F0FF]">
        <div className="max-w-5xl mx-auto px-8">
          <span className="text-xs font-semibold tracking-[0.22em] uppercase" style={{ color: ACCENT }}>
            Příležitost
          </span>
          <h2 className="text-4xl md:text-6xl font-black text-[#0f0028] mt-4 mb-4 leading-none"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-10">
            <div className="rounded-2xl p-7 relative overflow-hidden"
              ...
              <h3 className="text-lg font-black text-[#0f0028] mb-1" style={{ fontFamily: "'Panel Sans', sans-serif" }}>
                Ticketing
              </h3>
          ...
          <div className="rounded-2xl p-8 flex items-start gap-5"
            ...
            <div>
              <p className="text-base font-bold text-[#0f0028] leading-relaxed">
      ...
      <motion.section id="payment-methods" {...fade(0.1)} className="py-24" style={{ background: '#F8F6FC' }}>
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-14 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            Tři způsoby platby
          </h2>

          <div className="grid md:grid-cols-3 gap-5">
            <div className="bg-[#EDE5FF] rounded-2xl p-8" style={{ border: `2px solid ${OPEN_COLOR}20` }}>
              <div className="text-4xl mb-6">💳</div>
              <div className="text-xs font-bold tracking-[0.18em] uppercase mb-2" style={{ color: OPEN_COLOR }}>
                Platba kartou
              </div>
              <h3 className="text-2xl font-black text-[#0f0028] mb-3" style={{ fontFamily: "'Panel Sans', sans-serif" }}>
                Open-loop
              </h3>
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
            ...
            <div className="bg-[#EDE5FF] rounded-2xl p-8 relative" style={{ border: `2px solid ${ACCENT}30` }}>
            ...
            <div className="bg-[#EDE5FF] rounded-2xl p-8" style={{ border: '2px solid #e5e7eb' }}>
              <div className="text-4xl mb-6">💵</div>
      ...
      <motion.section id="venue-types" {...fade(0.1)} className="py-24" style={{ background: '#F8F6FC' }}>
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-4 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div className="bg-[#EDE5FF] rounded-2xl p-8" style={{ border: '1px solid #e5e7eb' }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="text-4xl">🎪</div>
                <div>
                  <h3 className="text-xl font-black text-[#0f0028]" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Festivaly</h3>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${OPEN_COLOR}12` }}>
                  <span className="text-sm font-semibold text-[#0f0028]">Open-loop</span>
                ...
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${ACCENT}12` }}>
                  <span className="text-sm font-semibold text-[#0f0028]">Closed-loop</span>
            ...
            <div className="bg-[#EDE5FF] rounded-2xl p-8" style={{ border: '1px solid #e5e7eb' }}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-[#0f0028]" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Arény</h3>
      ...
      {/* KEY BENEFITS */}
      <motion.section id="benefits" {...fade(0.1)} className="py-24 bg-[#F5F0FF]">
        <div className="max-w-5xl mx-auto px-8">
          <span className="text-xs font-semibold tracking-[0.22em] uppercase" style={{ color: ACCENT }}>
            Proč to funguje
          </span>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {BENEFITS.map((b, i) => (
              <div key={b.title} className="flex gap-5 p-7 rounded-2xl items-start group transition-all"
                ...
                <div>
                  <h3 className="font-black text-[#0f0028] mb-2 text-base"
      ...
      {/* THE JOURNEY */}
      <motion.section id="journey" {...fade(0.1)} className="py-24 bg-[#F5F0FF]">
        <div className="max-w-5xl mx-auto px-8">
          <span className="text-xs font-semibold tracking-[0.22em] uppercase" style={{ color: ACCENT }}>
            Od smlouvy k živé akci
          </span>
          <h2 className="text-4xl md:text-5xl font-black text-[#0f0028] mt-4 mb-5 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
              ...
              <div className="grid grid-cols-6 gap-2 relative">
                {JOURNEY.map((j) => (
                  <div key={j.step} className="flex flex-col items-center text-center">
                    ...
                    <h4 className="text-xs font-black text-[#0f0028] mb-1"
              ...
              <div key={j.step} className="flex gap-4">
                ...
                <div className="pb-8">
                  <div className="flex items-center gap-2 mb-1">
                    <span>{j.icon}</span>
                    <h4 className="font-black text-[#0f0028] text-sm"
                      style={{ fontFamily: "'Panel Sans', sans-serif" }}>{j.title}</h4>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {INFRA.map((item) => (
                <div key={item.title} className="bg-white rounded-2xl p-6" style={{ border: '1px solid #e5e7eb' }}>
                  ...
                  <h4 className="font-black text-[#0f0028] text-sm mb-1.5"
