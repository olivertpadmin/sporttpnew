      ...
      >
        ...
        {scale === 1 && (
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
            <span className="text-[10px] text-[#3A3342]/40 bg-[#F5F0FF]/80 px-3 py-1 rounded-full">
  ...
  return (
    <div className="min-h-screen bg-[#F5F0FF]" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      ...
      <section
        ...
        style={{ background: 'linear-gradient(150deg, #0f0028 0%, #1a0840 45%, #120630 100%)' }}
      >
      ...
      <div className="max-w-5xl mx-auto px-8 pb-24">
        ...
        <motion.section id="markets" {...fade(0.3)} className="mb-16 pt-16">
          <h2 className="text-2xl font-bold text-[#0f0028] mb-6">Sportovní PLG rodina</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {CLUBS.map((c) => (
              <div key={c.name} className="flex items-center gap-4 p-5 rounded-2xl border border-[#9333EA]/15 hover:border-[#E8A838]/40 transition-colors">
                <div style={{
                ...
                <div>
                  <div className="font-semibold text-[#0f0028]">{c.name}</div>
                  <div className="mt-2">
        ...
        <motion.section id="offer" {...fade(0.4)} className="mb-20">
          <h2 className="text-2xl font-bold text-[#0f0028] mb-6">Co nabízíme</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {PILLARS.map((p) => (
              <div key={p.title} className="p-6 rounded-2xl bg-[#EDE5FF]">
                <div className="w-8 h-1 rounded-full mb-4" style={{ background: ACCENT }} />
                <h3 className="font-bold text-[#0f0028] mb-2">{p.title}</h3>
        ...
        <motion.section
          ...
          style={{ background: 'linear-gradient(135deg, #0f0028 0%, #1a0840 100%)', padding: '56px 48px' }}
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f, i) => (
              <motion.div
                ...
                className={[
                  'p-6 rounded-2xl border border-[#9333EA]/15 hover:border-[#F59E0B]/30 transition-colors',
                  f.span === 'full' ? 'md:col-span-2 lg:col-span-3' : f.span === 'wide' ? 'md:col-span-2' : '',
                ].join(' ')}
                style={{ background: '#EDE5FF' }}
              >
                <span className="text-2xl mb-4 block">{f.icon}</span>
                <h3 className="font-bold text-[#0f0028] mb-2 text-base">{f.title}</h3>
