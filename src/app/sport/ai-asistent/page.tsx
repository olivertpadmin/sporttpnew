    ...
    <div className="relative select-none" style={{ width: 300, height: 240 }}>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: 8, fontWeight: 700, color: '#EDE5FF' }}>PLG AI Asistent</div>
        ...
        <div style={{ padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: 8, height: 'calc(100% - 43px)' }}>
          ...
          >
            <div style={{
              ...
              padding: '5px 8px',
              fontSize: 7, color: '#EDE5FF', lineHeight: 1.4,
            }}>
...
export default function SportAiAsistentPage() {
    ...
    <div className="min-h-screen bg-[#F5F0FF]" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      ...
      <div className="max-w-5xl mx-auto px-8 pb-24">
        ...
        <motion.section id="local-ai" {...fade(0.2)} className="pt-16 mb-16">
          <div className="rounded-3xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f0028 0%, #1a0040 100%)', border: '1px solid rgba(190,24,93,0.2)' }}>
        ...
        <motion.section id="promoter-questions" {...fade(0.25)} className="mb-16">
          <h2 className="text-2xl font-bold text-[#0f0028] mb-2">Na co se promotéři ptají</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={item.q} className="rounded-2xl overflow-hidden border border-[#9333EA]/15">
                <div className="flex gap-3 px-5 py-4 bg-[#EDE5FF] items-start">
                  <span className="text-lg shrink-0">💬</span>
                  <p className="text-sm font-semibold text-[#0f0028]">{item.q}</p>
                </div>
                <div className="flex gap-3 px-5 py-4 items-start" style={{ borderTop: '1px solid #0f002808' }}>
        ...
        <motion.section id="capabilities" {...fade(0.3)}>
          <h2 className="text-2xl font-bold text-[#0f0028] mb-6">Schopnosti</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {CAPABILITIES.map((c) => (
              <div key={c.title} className="flex gap-4 p-5 rounded-2xl border border-[#9333EA]/15 hover:border-[#BE185D]/30 transition-colors">
                <span className="text-2xl shrink-0">{c.icon}</span>
                <div>
                  <h3 className="font-semibold text-[#0f0028] text-sm mb-1">{c.title}</h3>
