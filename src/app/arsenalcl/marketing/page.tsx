...
function Card({
  ...
  return (
    ...
    >
      ...
      <h4
        className="text-base font-bold text-[#11002B] leading-snug"
...
function Section({
  ...
  return (
    <section
      id={id}
      className="py-20"
      style={{ background: dark ? 'linear-gradient(150deg,#07000f 0%,#130820 50%,#0f071c 100%)' : undefined }}
    >
      <div className="max-w-6xl mx-auto px-8">
        <motion.div {...iv(0.05)} className="mb-10">
          ...
          <h2
            className={`text-4xl md:text-5xl font-black mt-3 mb-4 leading-none ${dark ? 'text-white' : 'text-[#11002B]'}`}
            style={{ fontFamily: "'Panel Sans', sans-serif" }}
          >
            {heading}
          </h2>
...
// Page
// ─────────────────────────────────────────────────────────
export default function MarketingovaPodporaPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        ...
        style={{ background: 'linear-gradient(150deg, #021a0f 0%, #041c14 45%, #031510 100%)' }}
      >
        {/* Topbar */}
        <motion.nav
          className="relative w-full z-50 flex items-center gap-3 px-6 py-3"
          style={{
            background: 'rgba(2,26,15,0.92)',
