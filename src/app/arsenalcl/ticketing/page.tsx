...
const CLUBS = [
  ...
  { name: 'ŠK Arsenal ČL Bratislava',    logo: '/clubs/logo_arsenalcl_ba.png', competition: 'Niké Liga' },
  { name: 'HC Arsenal ČL Bratislava',    logo: '/clubs/logo_arsenalcl_hc.png', competition: 'Tipos Liga' },
