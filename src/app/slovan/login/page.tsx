...
export default function SlovanLoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    const res = await fetch('/api/slovan-auth', {
      method: 'POST',
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2" style={{
        ...
        background: 'radial-gradient(ellipse at center bottom, rgba(25,89,176,0.3) 0%, transparent 70%)',
        filter: 'blur(20px)',
      }} />
      ...
      <div className="relative z-10 flex flex-col items-center gap-7 w-full max-w-sm px-6">
        ...
        <div className="flex flex-col items-center gap-1.5 text-center">
          ...
          >
            Prezentace pro FC Slovan Liberec
          </p>
        </div>
