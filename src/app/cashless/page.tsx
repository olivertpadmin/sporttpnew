    ...
    <div className="relative select-none" style={{ width: 300, height: 240 }}>
      ...
      >
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.35)', fontSize: 8, fontWeight: 700, letterSpacing: '0.15em', marginBottom: 3 }}>TOTAL</p>
      ...
      >
        <span style={{ color: 'white', fontSize: 11, fontWeight: 700 }}>✓ Approved</span>
      </motion.div>
    </div>
  )
}
...
const FEATURES = [
  {
    ...
    desc: 'Assign any terminal to any vendor in seconds, and add more anytime during a live event. No waiting, no paperwork.',
    badge: 'vs. 1–2 weeks with competitors',
  },
  {
    number: '02',
    icon: '🏷️',
    title: 'Catalog & Pricing',
    desc: 'Set up product catalogs with multiple price lists. Different menus for different stalls. Reuse across future events.',
    badge: 'Custom per stall',
  },
  {
    number: '03',
    icon: '⚡',
    title: 'Live Transactions',
    desc: 'Filter by vendor, terminal, time, or amount. Full detail on every payment: who, when, where, how much.',
  ...
  },
  {
    ...
    icon: '📊',
    title: 'Dashboard',
    desc: 'Revenue by stall, top products, peak hours at a glance. Separate views for vendors and organisers.',
...
const BENEFITS = [
  {
    ...
    desc: 'See exactly what sells, at which stall, and when, live during the event. Make decisions in the moment.',
  },
  {
    icon: '🚫',
    title: 'No cash logistics',
    desc: 'No counting, no bank runs, no coin restocking. Eliminate the operational overhead of physical cash entirely.',
  },
  {
    icon: '⚡',
    title: 'Faster service',
    desc: 'Cashless payments are faster than handling cash. Shorter queues, more throughput, happier attendees.',
  },
  {
    icon: '💰',
    title: 'Automatic settlement',
    desc: 'All fees calculated automatically. Every party paid. No manual reconciliation; it just happens.',
  },
]

const JOURNEY = [
  { step: '01', icon: '📋', title: 'Onboarding',      desc: 'Vendor contact, registration & digital contract signing via DigiSign.' },
  { step: '02', icon: '⚙️', title: 'Configuration',   desc: 'Products, price lists, and terminals set up for your event.' },
  { step: '03', icon: '👥', title: 'Training',         desc: 'Your staff learn the system. We are on-site in person.' },
  { step: '04', icon: '📦', title: 'Deployment',       desc: 'Hardware delivered and installed before doors open.' },
  { step: '05', icon: '🎯', title: 'Live Operations',  desc: 'Real-time monitoring throughout. We fix things before you notice.' },
  { step: '06', icon: '💰', title: 'Settlement',       desc: 'Automatic calculation, documents generated, everyone paid.' },
]

const INFRA = [
  { icon: '🟢', title: 'High Availability',  desc: 'Enterprise-grade uptime. Stable servers built for critical operations.' },
  { icon: '☁️', title: 'Cloud-native',        desc: 'Kubernetes architecture designed for the spike when gates open.' },
  { icon: '🕐', title: '24 / 7 Support',      desc: 'Continuous monitoring and rapid response, day and night, during every event.' },
  { icon: '🏟️', title: 'Built for live',     desc: 'Developed by a team that runs infrastructure for national-scale systems.' },
]
...
export default function CashlessPage() {
  return (
    <div className="min-h-screen bg-white" style={{ '--product-color': ACCENT } as React.CSSProperties}>
      <ProductBreadcrumb activeSlug="cashless" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8 flex flex-col md:flex-row items-center gap-12 md:gap-0"
          ...
          <div className="flex-1 md:pr-12">
            ...
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
              ...
              Every transaction at your venue, routed through one smart system.
              {' '}<span className="text-white/85 font-medium">More revenue. Less friction. Full data.</span>
              {' '}Proven at stadiums and festivals across Central Europe.
            </motion.p>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-8">
            <div className="grid grid-cols-1 md:grid-cols-3">
              <div className="py-10 md:pr-10" style={{ borderRight: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className="text-sm font-semibold text-white/50 mt-3">Top single-event value processed</p>
                <p className="text-xs text-white/25 mt-1">Oktagon MMA · Eden Arena, Prague</p>
              </div>
              <div className="py-10 md:px-10" style={{ borderRight: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <p className="text-sm font-semibold text-white/50 mt-3">Additional revenue growth</p>
                <p className="text-xs text-white/25 mt-1">After cashless implementation</p>
              </div>
              <div className="py-10 md:pl-10">
                ...
                <p className="text-sm font-semibold text-white/50 mt-3">Total sales growth</p>
                <p className="text-xs text-white/25 mt-1">Across cashless-enabled events</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      <motion.section id="opportunity" {...fade(0.1)} className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-[#11002B] mt-4 mb-4 leading-none"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            You control ticketing.<br />
            <span style={{ color: ACCENT }}>Who controls your F&amp;B?</span>
          </h2>
          <p className="text-base text-[#3A3342]/55 max-w-xl mb-14 leading-relaxed">
            Organisers have full visibility over ticket sales, but food, drinks, and merchandise are typically handled by external suppliers with no data sharing. That gap costs revenue and insight.
          </p>

          <div className="grid md:grid-cols-3 gap-4 mb-10">
            {/* Ticketing - controlled */}
            <div className="rounded-2xl p-7 relative overflow-hidden"
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                You own the data. You set the rules. Every ticket, every fan, fully visible.
              </p>
            </div>
            ...
            <div className="rounded-2xl p-7 relative overflow-hidden"
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                Revenue handled externally. You see totals, if you&apos;re lucky. No stall-level data.
              </p>
            </div>
            ...
            <div className="rounded-2xl p-7 relative overflow-hidden"
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                Same story. Managed by a third party, invisible to your reporting.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl p-8 flex items-start gap-5"
            ...
            <div>
              <p className="text-base font-bold text-[#11002B] leading-relaxed">
                PLG Cashless gives organisers the same visibility and control over F&amp;B and merchandise that they already have over ticketing, with real-time data, automated settlement, and zero cash handling.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl p-8" style={{ border: `2px solid ${OPEN_COLOR}20` }}>
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                Standard Visa or Mastercard. Visitors pay directly with the card they already carry. No setup, no top-up. Requires connectivity.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 relative" style={{ border: `2px solid ${ACCENT}30` }}>
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                Visitors load credit onto a PLG wristband or card before or at the event. Unspent balance is fully refundable. Gives you maximum data and control.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8" style={{ border: '2px solid #e5e7eb' }}>
              ...
              <p className="text-sm text-[#3A3342]/60 leading-relaxed">
                Accepted as deposit only. Not recommended as a primary payment method, since it defeats the purpose of going cashless.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════════════
          FESTIVALS vs ARENAS - recommended mix
      ══════════════════════════════════════════════════ */}
      <motion.section id="venue-types" {...fade(0.1)} className="py-24" style={{ background: '#F8F6FC' }}>
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#11002B] mt-4 mb-4 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            Which combination<br />is right for you?
          </h2>
          <p className="text-sm text-[#3A3342]/55 mb-14 max-w-lg">
            The same platform, configured differently depending on your audience and venue type.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="bg-white rounded-2xl p-8" style={{ border: '1px solid #e5e7eb' }}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-[#11002B]" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Festivals</h3>
                  <p className="text-xs text-[#3A3342]/50">One-time & multi-day events</p>
                </div>
              </div>
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${OPEN_COLOR}12` }}>
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${OPEN_COLOR}25`, color: OPEN_COLOR }}>Primary</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${ACCENT}12` }}>
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${ACCENT}25`, color: ACCENT }}>Secondary</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: '#f3f4f6' }}>
                  ...
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-gray-100 text-gray-400">Not recommended</span>
                </div>
              </div>
              <p className="text-xs text-[#3A3342]/50 leading-relaxed">
                Closed-loop and open-loop together ensure full control over cash-flow and eliminate the grey economy at your site.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8" style={{ border: '1px solid #e5e7eb' }}>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-[#11002B]" style={{ fontFamily: "'Panel Sans', sans-serif" }}>Arenas</h3>
                  <p className="text-xs text-[#3A3342]/50">Stadiums & permanent venues</p>
                </div>
              </div>
              <div className="space-y-3 mb-6">
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${OPEN_COLOR}12` }}>
                  <span className="text-sm font-semibold text-[#11002B]">Open-loop</span>
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${OPEN_COLOR}20`, color: OPEN_COLOR }}>Primary</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: `${ACCENT}12` }}>
                  <span className="text-sm font-semibold text-[#11002B]">Closed-loop</span>
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full" style={{ background: `${ACCENT}25`, color: ACCENT }}>Supplementary</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl" style={{ background: '#f3f4f6' }}>
                  <span className="text-sm font-semibold text-[#3A3342]/40">Cash</span>
                  <span className="text-xs font-bold px-2 py-0.5 rounded-full bg-gray-100 text-gray-400">Limited only</span>
                </div>
              </div>
              <p className="text-xs text-[#3A3342]/50 leading-relaxed">
                Visitors expect to pay by card. Stable infrastructure makes open-loop the natural primary choice for permanent venues.
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.section id="benefits" {...fade(0.1)} className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#11002B] mt-4 mb-14 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            What changes<br />when you go cashless
          </h2>
      ...
      <motion.section id="platform" {...fade(0.1)} className="py-24"
        ...
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mt-4 mb-14 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            Built for how<br />events actually run
          </h2>
      ...
      <motion.section id="journey" {...fade(0.1)} className="py-24 bg-white">
        <div className="max-w-5xl mx-auto px-8">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#11002B] mt-4 mb-5 leading-tight"
            style={{ fontFamily: "'Panel Sans', sans-serif" }}>
            We take you<br />from zero to live
          </h2>
          <p className="text-sm text-[#3A3342]/55 mb-16 max-w-lg">
            We don&apos;t just supply software; we guide you through the entire process. Every event, start to finish.
          </p>
      ...
      ══════════════════════════════════════════════════ */}
      <motion.section id="infrastructure" {...fade(0.1)} className="py-24"
        ...
        <div className="max-w-5xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-[#11002B] mt-4 mb-5 leading-tight"
                style={{ fontFamily: "'Panel Sans', sans-serif" }}>
                Enterprise-grade.<br />Built for<br />
                <span style={{ color: ACCENT }}>live events.</span>
              </h2>
              <p className="text-sm text-[#3A3342]/55 leading-relaxed">
                Backed by the infrastructure expertise of a media group that has operated some of the largest web platforms in Central Europe. When your gates open and thousands of transactions hit at once, we don&apos;t blink.
              </p>
            </div>
      ...
      <SectionNav
        ...
        sections={[
          ...
          { id: 'venue-types',     label: 'Festivals vs Arenas' },
